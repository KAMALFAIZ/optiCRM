/**
 * Scraper Elections Communales Maroc 2015
...
const PAGE_PATH     = '/elections/communales/resultats.aspx?Id=l9ziT4TKNOxo6MIM81hkUA%3D%3D&IE=1';
const ASMX_ELUS     = '/Electionweb.asmx/getListElus_Com';
const C_ELECTION    = 9;
const DELAY_API     = 1500;
const DELAY_POST    = 2000;
const PROGRESS_FILE = 'scrape_progress_communales_2015.json';
const OUT_FILE      = 'elections_communales_2015.csv';
...
async function main() {
  console.log('=== Scraper Elections Communales 2015 ===');
