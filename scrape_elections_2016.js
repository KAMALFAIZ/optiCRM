/**
 * Scraper Elections Legislatives Maroc 2016
...
async function main() {
  const allData = [];
  const progressFile = path.join(OUT_DIR, 'scrape_progress_2016.json');
  let startIdx = 0;
  ...
  // Write JSON
  const jsonPath = path.join(OUT_DIR, 'elections_2016.json');
