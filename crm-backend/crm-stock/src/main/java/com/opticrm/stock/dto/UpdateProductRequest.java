...
public class UpdateProductRequest {
    ...
    @Size(max = 500, message = "L'URL de la fiche technique ne doit pas dépasser 500 caractères")
    private String datasheetUrl;

    @Size(max = 255, message = "Le nom de la fiche technique ne doit pas dépasser 255 caractères")
